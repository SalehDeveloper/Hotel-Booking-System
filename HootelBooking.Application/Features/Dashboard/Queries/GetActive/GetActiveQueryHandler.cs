...
{
    public class GetActiveQueryHandler : IRequestHandler<GetActiveQuery, Result<List<UserResponseDto>>>
    {
        private readonly IUserRepository _userRepository;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IMapper _mapper;

        public GetActiveQueryHandler(IUserRepository userRepository, UserManager<ApplicationUser> userManager, IMapper mapper)
        {
        ...
        public async Task<Result<List<UserResponseDto>>> Handle(GetActiveQuery request, CancellationToken cancellationToken)
        {
